...
Requires an API key using the Authorization Bearer Header.
 * @param {string} apiVersion - 
 * @param {string} [id] - A specific RSS feed ID that you want to retrieve. Optional.
 * @returns {Promise<HttpResponse<any>>} 
 */
...
Requires an API key using the Authorization Bearer Header.
 * @param {string} apiVersion - 
 * @param {string} [rssFeedId] - The RSS Feed ID of the RSS Feed you want to retrieve the scraped items of.
 * @returns {Promise<HttpResponse<any>>} 
 */

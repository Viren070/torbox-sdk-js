...
export const getHosterListOkResponseDataRequest = z.lazy(() => {
  return z
    .object({
      dailyBandwidthLimit: z.number().nullish(),
      dailyBandwidthUsed: z.number().nullish(),
      dailyLinkLimit: z.number().nullish(),
      dailyLinkUsed: z.number().nullish(),
      domains: z.array(z.string()).nullish(),
      domais: z.array(z.string()).nullish(),
      domaisn: z.array(z.string()).nullish(),

 ...
 * @param {string} [id] - Determines the queued download requested, will return an object rather than list. Optional.
 ...
 * @param {string} [type] - The type of the queued download you want to retrieve. Can be "torrent", "usenet" or "webdl". Optional. Default is "torrent".

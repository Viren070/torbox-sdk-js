...
var createUsenetDownloadRequestResponse = z28.lazy(() => {
  return z28.object({
    file: z28.instanceof(ArrayBuffer).optional(),
    link: z28.string().optional()
  }).transform((data) => ({
...
var getUsenetListOkResponseData = z33.lazy(() => {
  return z33.object({
    ...
    authId: z33.string().optional(),
    availability: z33.number().optional(),
    createdAt: z33.string().optional(),
    downloadFinished: z33.boolean().optional(),
    downloadPresent: z33.boolean().optional(),
    downloadSpeed: z33.number().optional(),
    downloadState: z33.string().optional(),
    eta: z33.number().optional(),
    expiresAt: z33.string().optional(),
    files: z33.array(dataFiles4).optional(),
    hash: z33.string().optional(),
    id: z33.number().optional(),
    inactiveCheck: z33.number().optional(),
    name: z33.string().optional(),
    progress: z33.number().optional(),
    server: z33.number().optional(),
    size: z33.number().optional(),
    torrentFile: z33.boolean().optional(),
    updatedAt: z33.string().optional(),
    uploadSpeed: z33.number().optional()
  });
});
var getUsenetListOkResponseDataResponse = z33.lazy(() => {
  return z33.object({
    active: z33.boolean().optional(),
    auth_id: z33.string().optional(),
    availability: z33.number().optional(),
    created_at: z33.string().optional(),
    download_finished: z33.boolean().optional(),
    download_present: z33.boolean().optional(),
    download_speed: z33.number().optional(),
    download_state: z33.string().optional(),
    eta: z33.number().optional(),
    expires_at: z33.string().optional(),
    files: z33.array(dataFiles4Response).optional(),
    hash: z33.string().optional(),
    id: z33.number().optional(),
    inactive_check: z33.number().optional(),
    name: z33.string().optional(),
    progress: z33.number().optional(),
    server: z33.number().optional(),
    size: z33.number().optional(),
    torrent_file: z33.boolean().optional(),
    updated_at: z33.string().optional(),
    upload_speed: z33.number().optional()
  }).transform((data) => ({
    active: data["active"],
    authId: data["auth_id"],
    availability: data["availability"],
...
var getUsenetListOkResponse = z34.lazy(() => {
  return z34.object({
    data: z34.array(getUsenetListOkResponseData).optional(),
...
var getUsenetListOkResponseResponse = z34.lazy(() => {
  return z34.object({
    data: z34.array(getUsenetListOkResponseDataResponse).optional(),
    detail: z34.string().optional(),
    error: z34.any().optional().nullable(),
    success: z34.boolean().optional()
  }).transform((data) => ({
...
var getUsenetListOkResponseRequest = z34.lazy(() => {
  return z34.object({
    data: z34.array(getUsenetListOkResponseDataRequest).optional(),
    detail: z34.string().optional(),
    error: z34.any().optional().nullable(),
    success: z34.boolean().optional()
  }).transform((data) => ({

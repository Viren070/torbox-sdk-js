...
var createUsenetDownloadRequestResponse = import_zod30.z.lazy(() => {
  return import_zod30.z.object({
    file: import_zod30.z.instanceof(ArrayBuffer).optional(),
    link: import_zod30.z.string().optional()
  }).transform((data) => ({
...
var getUsenetListOkResponseData = import_zod35.z.lazy(() => {
  return import_zod35.z.object({
    active: import_zod35.z.boolean().optional(),
    authId: import_zod35.z.string().optional(),
    availability: import_zod35.z.number().optional(),
    createdAt: import_zod35.z.string().optional(),
    downloadFinished: import_zod35.z.boolean().optional(),
    downloadPresent: import_zod35.z.boolean().optional(),
    ...
    files: import_zod35.z.array(dataFiles4).optional(),
    hash: import_zod35.z.string().optional(),
    id: import_zod35.z.number().optional(),
    inactiveCheck: import_zod35.z.number().optional(),
    name: import_zod35.z.string().optional(),
    progress: import_zod35.z.number().optional(),
    server: import_zod35.z.number().optional(),
    size: import_zod35.z.number().optional(),
    torrentFile: import_zod35.z.boolean().optional(),
    updatedAt: import_zod35.z.string().optional(),
    uploadSpeed: import_zod35.z.number().optional()
  });
});
var getUsenetListOkResponseDataResponse = import_zod35.z.lazy(() => {
  return import_zod35.z.object({
    active: import_zod35.z.boolean().optional(),
    auth_id: import_zod35.z.string().optional(),
    availability: import_zod35.z.number().optional(),
    created_at: import_zod35.z.string().optional(),
    download_finished: import_zod35.z.boolean().optional(),
    download_present: import_zod35.z.boolean().optional(),
    download_speed: import_zod35.z.number().optional(),
    download_state: import_zod35.z.string().optional(),
    eta: import_zod35.z.number().optional(),
    expires_at: import_zod35.z.string().optional(),
    files: import_zod35.z.array(dataFiles4Response).optional(),
    hash: import_zod35.z.string().optional(),
    id: import_zod35.z.number().optional(),
    inactive_check: import_zod35.z.number().optional(),
    name: import_zod35.z.string().optional(),
    progress: import_zod35.z.number().optional(),
    server: import_zod35.z.number().optional(),
    size: import_zod35.z.number().optional(),
    torrent_file: import_zod35.z.boolean().optional(),
    updated_at: import_zod35.z.string().optional(),
    upload_speed: import_zod35.z.number().optional()
  }).transform((data) => ({
    active: data["active"],
    authId: data["auth_id"],
    availability: data["availability"],
...
var getUsenetListOkResponse = import_zod36.z.lazy(() => {
  return import_zod36.z.object({
    data: import_zod36.z.array(getUsenetListOkResponseData).optional(),
...
var getUsenetListOkResponseResponse = import_zod36.z.lazy(() => {
  return import_zod36.z.object({
    data: import_zod36.z.array(getUsenetListOkResponseDataResponse).optional(),
    detail: import_zod36.z.string().optional(),
    error: import_zod36.z.any().optional().nullable(),
    success: import_zod36.z.boolean().optional()
  }).transform((data) => ({
...
var getUsenetListOkResponseRequest = import_zod36.z.lazy(() => {
  return import_zod36.z.object({
    data: import_zod36.z.array(getUsenetListOkResponseDataRequest).optional(),
    detail: import_zod36.z.string().optional(),
    error: import_zod36.z.any().optional().nullable(),
    success: import_zod36.z.boolean().optional()
  }).transform((data) => ({
